...
<h3>Read</h3>
To read an object create a builder object that implements [link][https://github.com/NathanJAdams/MeshIO/blob/master/src/com/ripplar_games/mesh_io/IMeshBuilder.java]. Then call the meshIO.read() method passing in the builder and a file path to read from. If unsuccessful, a MeshIOException is thrown.
