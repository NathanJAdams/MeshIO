...
<h3>Read</h3>
To read an object create a builder object that implements [link](TODO.md). Then call the meshIO.read() method passing in the builder and a file path to read from. If unsuccessful, a MeshIOException is thrown.
