...
public abstract class PlyDataType {
   private static class Int extends PlyDataType {
      ...
      @Override
      public boolean readDatum(IPlyBuilder<?> loader, String elementName, int elementIndex, String propertyName, String datum) {
         int i;
         try {
            i = readCount(datum);
      ...
      @Override
      public boolean readDatum(IPlyBuilder<?> loader, String elementName, int elementIndex, String propertyName, PrimitiveInputStream pis,
            boolean isBigEndian) {
         try {
      ...
      @Override
      public boolean readDatumList(IPlyBuilder<?> loader, String elementName, int elementIndex, String propertyListName, int count, String[] parts,
            int partIndex) {
      ...
      @Override
      public boolean readDatumList(IPlyBuilder<?> loader, String elementName, int elementIndex, String propertyListName, int count,
   ...
   public abstract boolean readDatum(IPlyBuilder<?> loader, String elementName, int elementIndex, String propertyName, String datum);

   public abstract boolean readDatum(IPlyBuilder<?> loader, String elementName, int elementIndex, String propertyName, PrimitiveInputStream pis,
         boolean isBigEndian);

   public abstract boolean readDatumList(IPlyBuilder<?> loader, String elementName, int elementIndex, String propertyName, int count, String[] parts,
         int partIndex);
